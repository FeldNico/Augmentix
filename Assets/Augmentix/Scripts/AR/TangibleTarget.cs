...
namespace Augmentix.Scripts.AR
{
    ...
    {
        public static TangibleTarget Instance = null;
        ...
        void Start()
        {
            ...
            ARUI.Instance.RemovePlayer.onClick.AddListener(() =>
            {
                ...
                PlayerSync.transform.parent = _mapTarget.Scaler.transform;
        ...
        void Update()
        {
            ...
            {
                if (_treveris != null)
                    _treveris.transform.localPosition = _treveris.transform.localScale.x * -PlayerSync.transform.localPosition;
            }
